                ...
                {data.founders.map((founder, index) => (
                  <div key={index} className="flex flex-col items-center text-center group">
                    <div className="relative mb-6">
                      <div className="absolute inset-0 bg-primary/10 rotate-3 rounded-lg group-hover:rotate-6 transition-transform duration-300" />
                      <div className="absolute inset-0 bg-primary/10 -rotate-3 rounded-lg group-hover:-rotate-6 transition-transform duration-300" />
                      <div className="relative h-64 w-56 overflow-hidden rounded-lg shadow-lg border-4 border-white bg-white">
                        <img
                          src={founder.image}
                          alt={founder.name}
                          className="w-full h-full object-cover filter sepia-[.25] group-hover:sepia-0 transition-all duration-500"
                        />
                      </div>
                    </div>
