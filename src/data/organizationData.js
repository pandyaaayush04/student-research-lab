export const organizationData = {
  mmpsrpc: {
    ...
    goals: [
      "Fostering a culture of high-quality research and innovation.",
      "Developing analytical and critical thinking skills.",
      "Promoting interdisciplinary collaboration and teamwork.",
      "Stimulating cutting-edge ideas and impactful outcomes.",
      "Equipping students with advanced problem-solving skills."
    ],
    image: "/MMPSRPC Logo.webp", // Assuming this exists based on Navbar usage
    contact: {
  ...
  ksv: {
    ...
    image: "/KSV Logo.webp", // Assuming this exists
    features: [
